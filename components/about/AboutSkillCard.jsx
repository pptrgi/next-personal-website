...
const AboutSkillCard = ({ name, description, specifics, tools }) => {
  return (
    <div className="flex_col gap-[2rem] items-center bg-containerColor rounded-md py-[2.5rem] px-[0.75rem] col-span-1 min-h-[400px] z-20 shadow-sm md480:col-span-4 md480:px-[0.25rem] md480:py-[2rem] lg1023:py-[2.5rem] lg1023:px-[1.25rem] md480:min-h-auto">
