export const projectsData = [
  {
    ...
    images: [
      ...
      {
        source: "/images/projects/qazini/q-hit-wrong-jackpot.png",
        text: "Hit Wrong Jackpot",
      },
    ],
    technologies: [
      "Apollo",
