            ...
            <div className="hidden justify-between items-center w-8/12 md800:flex lg1120:w-1/2">
              <div className="flex items-center gap-x-[1.5rem] md800:flex lg1023:gap-x-[2rem]">
                <Link href={"/"} className="relative group">
                  <span className="tracking-wide text-titleColor group-hover:text-titleColor/40">
                    Home
                  </span>
                  <span className="block absolute bottom-0 left-0 w-[0.9rem] h-[0.125rem] bg-titleColor/60 group-hover:hidden"></span>
                </Link>
                <Link href={"/#about"} className="relative group">
                  <span className="tracking-wide text-titleColor/40 group-hover:text-titleColor">
                    About
                  </span>
